...
%         EXPLORE_DIR_OVERRIDE = '';
        ...
        EXPERIMENTS = {
            ...
            @covexp.experiments.get_model_simulates                 % 4 获得采样时间
            @covexp.experiments.fix_input_loc                       % 5 只能用于单个实验；不能和12837合用
            @covexp.experiments.do_difftest                         % 6
            @difftest.experiments.comp_with_pp                      % 7 做7必须要有3（PP是emi生成的一个文件后缀名）
       ...
       DO_THESE_EXPERIMENTS = [1 2 8 3 7]; % Multiple experiments
