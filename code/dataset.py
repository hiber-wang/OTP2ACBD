...
MathOperations = ['Abs', 'Add', 'AlgebraicConstraint', 'Assignment', 'Bias', 'ComplextoMagnitudeAngle',
                  ...
                  'SliderGain', 'Sqrt', 'Squeeze', 'TrigonometricFunction', 'UnaryMinus', 'WeightedSampleTimeMath', 'Sum',
...
Sources = ['BandLimitedWhiteNoise', 'ChirpSignal', 'Clock', 'Constant', 'CounterFreeRunning', 'CounterLimited',
          ...
          'RepeatingSequenceInterpolated', 'RepeatingSequenceStair', 'SignalBuilder', 'SignalEditor', 'SignalGenerator',
          'SineWave', 'Step', 'UniformRandomNumber', 'WaveformGenerator']

Dashboard = ['CallbackButton', 'CheckBox', 'ComboBox', 'DashboardScope', 'Display', 'Edit', 'Gauge', 'HalfGauge', 'Knob',
...
MatrixOperations = ['CrossProduct', 'HermitianTranspose', 'IdentityMatrix', 'IsSymmetric', 'IsTriangular', 'MatrixSquare',
                    'Transpose']
...
ModelVerification = ['Assertion', 'CheckDynamicGap', 'CheckDynamicRange', 'CheckStaticGap', 'CheckStaticRange',
                     'CheckDiscreteGradient', 'CheckDynamicLowerBound', 'CheckDynamicUpperBound', 'CheckInputResolution',
                     'CheckStaticLowerBound', 'CheckStaticUpperBound']

ModelWideUtilities = ['Block Support Table', 'DocBlock', 'Model Info', 'TimedBasedLinearization', 'TriggerBasedLinearization']
...
String = ['ASCIItoString', 'ComposeString', 'ScanString', 'StringCompare', 'StringConcatenate', 'StringConstant',
          'StringContains', 'StringCount', 'StringFind', 'StringLength', 'StringtoASCII', 'StringtoDouble', 'StringtoEnum',
...
bug0 = ['Sample1001.mdl', 'Sample161.mdl', 'Sample215.mdl', 'Sample231.mdl', 'Sample274.mdl', 'Sample295.mdl', 'Sample299.mdl', 'Sample355.mdl', 'Sample37.mdl', 'Sample39.mdl', 'Sample404.mdl', 'Sample409.mdl', 'Sample487.mdl', 'Sample527.mdl', 'Sample541.mdl', 'Sample607.mdl', 'Sample666.mdl', 'Sample681.mdl', 'Sample732.mdl', 'Sample742.mdl', 'Sample752.mdl', 'Sample811.mdl', 'Sample845.mdl', 'Sample862.mdl', 'Sample91.mdl', 'Sample92.mdl', 'Sample974.mdl', 'Sample984.mdl', 'Sample992.mdl']
bug1 = ['Sample362.mdl', 'Sample745.mdl']
bug2 = ['Sample170.mdl', 'Sample301.mdl', 'Sample490.mdl', 'Sample546.mdl', 'Sample673.mdl', 'Sample676.mdl', 'Sample683.mdl', 'Sample807.mdl', 'Sample809.mdl', 'Sample870.mdl']
bug3 = ['Sample646.mdl']
bug4 = ['Sample612.mdl']
bug5 = ['Sample334.mdl']
bug6 = ['Sample754.mdl']
